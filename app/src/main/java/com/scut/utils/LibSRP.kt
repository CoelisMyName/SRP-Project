...
object LibSRP {
    ...
    external fun registerAudioGLRender(controller: ModuleController, pointer: Long): Boolean
    external fun unregisterAudioGLRender(controller: ModuleController, pointer: Long): Boolean
}